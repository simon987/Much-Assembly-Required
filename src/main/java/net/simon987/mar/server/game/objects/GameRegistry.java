...
public class GameRegistry {
    ...
    private final HashMap<String, Class<? extends GameObject>> gameObjects;
    private final HashMap<String, Class<? extends HardwareModule>> hardware;
    private final HashMap<Integer, Class<? extends Item>> items;
    private final HashMap<Integer, Class<? extends Tile>> tiles;
